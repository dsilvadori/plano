...
<x-app-layout>
        ...
        <div class="hero-panel">
            <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div class="min-w-0">
                    ...
                    <h1 class="mt-2 max-w-4xl break-words text-2xl font-semibold text-white sm:text-3xl">{{ $lesson->title }}</h1>
    ...
    <div class="grid min-w-0 gap-6 xl:grid-cols-[minmax(0,1fr)_20rem]" x-data="lessonCompletion(@js($isCompleted))">
        <section class="card-panel min-w-0">
            @if (session('status'))
            ...
            <div id="lesson-video-frame" class="lesson-video-frame">
            ...
            <div class="mt-6 flex min-w-0 flex-col gap-4 rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 lg:flex-row lg:items-start lg:justify-between">
                <div class="min-w-0">
                ...
                <form method="POST" action="{{ route('courses.lessons.complete', [$course->slug, $lesson]) }}" class="w-full min-w-0 lg:w-auto lg:shrink-0" @submit.prevent="toggle">
                    @csrf
                    <button type="submit" class="w-full rounded-2xl bg-amber-300 px-4 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-amber-400/20 disabled:cursor-wait disabled:opacity-70 sm:px-5" :disabled="loading">
                ...
                >
                    <div class="flex flex-col gap-3 border-b border-white/10 p-5 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0">
                            ...
                            <h2 class="mt-2 text-xl font-semibold text-white sm:text-2xl">Estude este conteúdo com IA</h2>
                        </div>
                        @if ($summaryBlocks !== [])
